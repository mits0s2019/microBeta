    ...
    for(let button of buttons){
        if(button.id===id){
            if(button.clicked===false){
                ...
                movieButton.className='glyphicon glyphicon-pushpin btn input-block-level btn-success';
                button.clicked=true;
            }else{
                movieButton.innerText="Add to List";
                movieButton.className='glyphicon glyphicon-pushpin btn input-block-level btn-danger';
